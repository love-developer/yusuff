...
export const AppShell = ({ children }) => (
  <div className="min-h-screen px-4 py-6">
    <div className="mx-auto grid w-full max-w-[1304px] grid-cols-[260px_minmax(0,1028px)] gap-4">
      {children}
    </div>
  </div>
);
...
export const Sidebar = ({ items, active, onChange }) => (
  <aside
    className="rounded-[12px] border-[1px] border-[#E5E7EC] shadow-[0px_4px_30px_0px_#0000000D];
 bg-white p-[24px] max-w-[260px]"
  >
    <h2 className="mb-4 text-[24px] font-[600] text-[#111111]">
      Seekheed Book
    </h2>
...
export const TopStatCard = ({ icon, value, label, note }) => (
  <div
    className="h-[156px] w-[244px] rounded-[12px] border border-[#E5E7EC] bg-[#FFFFFF] p-[24px] flex flex-col gap-[16px] shadow: 0px 1px 10px 0px #00000008;
"
  >
...
export const CardPanel = ({ title, children }) => (
  <section
    className="px-[20px] py-[20px] min-h-[104px] min-w-[354px] rounded-[12px] border border-[#E5E7EC] bg-[#FFFFFF] flex flex-col justify-center gap-[12px] shadow: 0px 3px 30px 0px #0000000D;
"
  >
    {title && (
      <h3 className="text-[13px] font-[700] text-[#111111]">{title}</h3>
    )}
    {children}
  </section>
);
